...
public class Runner {
    public static void main(String[] args) {
        ArrayList<Queue> cashboxQueues = new ArrayList<>();
        ...
        cashboxQueues.add(new Queue(peopleList1, 0));
        ...
        cashboxQueues.add(new Queue(peopleList2, 1));
        ...
        cashboxQueues.add(new Queue(peopleList3, 2));

        Cafe fastFoodRestaurant = new Cafe(cashboxQueues);
